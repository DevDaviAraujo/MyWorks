...
?>    
    ...
    <form name="EditUser" method="POST" action="">
            ...
            <div class="row">
                <div class="col">
                    <a href="exibir_estante.php"> 
                        <button class="btn btn-primary" type="button" value="Voltar" > Voltar </button>
                    <a>
                </div>
            </div>   <br> 
            <div class="row">
