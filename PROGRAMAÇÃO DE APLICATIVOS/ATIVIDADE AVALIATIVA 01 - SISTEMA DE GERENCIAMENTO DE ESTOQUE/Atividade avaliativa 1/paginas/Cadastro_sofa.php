...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="container-sm">
        <center>
            <legend>CADASTRO DE SOFÁS</legend>
        </center>
        <form action="" method="POST">
            ...
            <input type="text" name="lugares" required><br>
            <label>Descrição:</label><br>
            <input type="text" name="descricao" required><br><br>
            <input type="submit" value="CADASTRAR" class="sub" name="addsofa">
        </form>
    </div>
</body>
</html>