...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="container-sm">
        <center>
            <legend>CADASTRO DE ESTANTE</legend>
        </center>
        <form action="" method="POST">
            ...
            <input type="submit" value="CADASTRAR" class="sub" name="addestante">
        </form>
    </div>
</body>
</html>