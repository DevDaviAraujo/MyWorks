    ...
    <div class="album py-5">
      ...
      <center>
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            <li class="page-item">
              <a class="page-link" href="geladeira1.php" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
              </a>
            </li>
            <li class="page-item"><a class="page-link" href="geladeira1.php">1</a></li>
            <li class="page-item"><a class="page-link" href="geladeira2.php">2</a></li>
            <li class="page-item">
              <a class="page-link" href="geladeira2.php" aria-label="Next">
