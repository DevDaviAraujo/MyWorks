...
require_once('cadastrofreezer.php');
...
if (!empty($formData['editar'])) {
  //var_dump($formData);
  $editfreezer = new freezer();
  $editfreezer->formData = $formData;
  $value = $editfreezer->edit();
...
if (!empty($id)) {
  ...
  if (!empty($formData['deletar'])) {
      ...
      if (!empty($id)) {
          ...
          //Instanciar a classe e criar o objeto
          $deleteFreezer = new freezer();

          //Enviando o id para o atributo id da classe freezer
          $deleteFreezer->id = $id;

          $deleteFreezer = $deleteFreezer->delete();

          header('location:viewfreezer.php');
...
<div class="form">
    <form action="" method="POST" name="editfreezer">
      <center>
        <h2>Editar Freezer</h2> 
      </center>
      <br>
      <table>
        <tr>
        ...
        <tr>
          <td><label>Congelamento rápido:</label><br><input type="text" name="congelamentorapido" value="<?php echo $tipoprateleiras;?>" required></td>
          <td><label>controletemperatura:</label><br><input type="text" name="controletemperatura" value="<?php echo $preco;?>" required></td>
          <td><label>ambiente:</label><br><input type="text" name="ambiente" value="<?php echo $quantidade;?>" required></td>
        </tr>
        <tr>
          <td><label>duplafuncao:</label><br><input type="text" name="duplafuncao" value="<?php echo $tipoprateleiras;?>" required></td>
          <td><label>gavetas:</label><br><input type="text" name="gavetas" value="<?php echo $preco;?>" required></td>
        </tr>
        <tr>
          <Td></Td>
      ...
      <input value="Deletar" class="sub" name="deletar" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer d-flex"> <br> <br>
