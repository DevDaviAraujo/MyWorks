...
<?php
    ...
    $listgeladeira = new listgeladeira();
    $result_geladeira = $listgeladeira->list();
    ...
    <thead>
      <tr>
        ...
        <th scope='col'>Tipo/Prateleiras</th>
    ...
    foreach ($result_geladeira as $row_geladeira) {

        extract($row_geladeira);
        echo "
        <tr>
        ...
        <td> $quantidade </td>
        <td> $quantidademin</td>
        <td> <a href='editar_geladeira.php?id=$codigo'><img src='..//img//lapis3.png' alt=''></a> </td>
         </tr>";
    }
    echo "</tbody>
    </table>
