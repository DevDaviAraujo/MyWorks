...
require("cadastrogeladeiras.php");

/* Recebendo os valores pelo vetor */
$formData = filter_input_array(INPUT_POST,FILTER_DEFAULT);

    /* if cuja condição verifica o input do botão de cadastro pelo usuário */ 
if(!empty($formData['addgeladeira'])) {
    $creategeladeira = new geladeira();
    $creategeladeira->formData = $formData;
    $result = $creategeladeira->create();
...
<div class="form">
    <form action="" method="POST">
      ...
      <br>
      <center>
      <input value="ENVIAR" class="sub" type="submit" name="addgeladeira">
      </center>
    </form>
  </div>
</body>
